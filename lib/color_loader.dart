...
class ColorLoader3 extends StatefulWidget {
  ...
  ColorLoader3({this.radius = 30.0, this.dotRadius = 3.0, this.dotType});
...
class _ColorLoader3State extends State<ColorLoader3>
  ...
  void initState() {
    ...
    dotType = widget.dotType ?? DotType.circle;
...
class Dot extends StatelessWidget {
  ...
  Dot({required this.radius, this.color, this.type, this.icon});
